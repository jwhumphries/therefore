...
function subscribeFonts(callback: () => void) {
  fontsListeners.add(callback);
  return () => fontsListeners.delete(callback);
}

function getFontsLoaded() {
  return fontsLoadedCache;
}

function getServerFontsLoaded() {
  return false;
}
